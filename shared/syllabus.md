...
#### Primary Instructor: Dr. Hagen Fritz _(he/him)_
...
* Office Hours:
  * {Day} {Time}
* Leading the {Day} Lab Section

#### Peer Advisor: {Peer Advisor Name}
* Zoom Link: {Zoom Link}
* Office Hours:
  * {Day} {Time}
...
#### Course Websites
* Canvas: [Link]({Canvas URL})
* GitHub: [Link]({GitHub URL})

### Course Description
Welcome 👋🏻 CE 311K introduces Python programming, computational methods, and AI-assisted problem solving for civil, architectural, and environmental engineering. Students will develop computational thinking skills, learn to write and interpret Python code, collaborate effectively with AI tools, and apply these skills to solve real-world engineering problems.
...
### Grading Breakdown
Your final grade will be assessed from 0 to 100 using the +/- system of grading. Your total grade will be determined based on the course assignments with the following weights:
- **Homework ({HW Weight}%)**: Broader concepts and smaller-scale coding problems to reinforce programming fundamentals and provide additional practice. Your top n-1 homeworks will be counted toward your final grade.
- **Lab Assignments ({Lab Weight}%)**: Weekly lab exercises that directly apply programming to solve engineering problems, reinforcing lecture topics. Your top n-1 lab assignments will be counted toward your final grade.
- **Exams ({Exam Weight}%)**: Two exams focused on assessing students' understanding of core programming concepts and their ability to apply them.
- **Final Project ({Project Weight}%)**: Students will demonstrate their programming skills by solving either (1) a predefined, multipart engineering problem or (2) a project of their choosing (subject to instructor approval).

### Course Schedule
| Week | Dates       | Main Topics                              | Lab Focus                                           | Homework  |
|-----:|:-----------:|:-----------------------------------------|:----------------------------------------------------|:----------|
| 1    | {Dates}     | **Course Intro & Data Types**            | *No Lab*                                            | *No HW*   |
| 2    | {Dates}     | **Conditionals & Lists**                 | *No Lab*                                            | HW #1     |
| 3    | {Dates}     | **Collections & Loops**                  | Expressions & Conditionals                          | HW #2     |
| 4    | {Dates}     | **Functions, Objects & Methods**         | Collections & Loops                                 | HW #3     |
| 5    | {Dates}     | **Classes & Libraries**                  | Functions                                           | HW #4     |
| 6    | {Dates}     | **Review & Exam #1**                     | *No Lab*                                            | *No HW*   |
| 7    | {Dates}     | **NM I: Differentiation & Integration**  | Differentiation                                     | HW #5     |
| 8    | {Dates}     | **Debugging & Datetime**                 | Integration                                         | HW #6     |
| 9    | {Dates}     | **NM II: Gradients & Roots**             | Gradients                                           | HW #7     |
| –    | {Dates}     | **{Break}**                              | *No Lab*                                            | *No HW*   |
| 10   | {Dates}     | **File I/O & Data Visualization**        | Root Finding                                        | HW #8     |
| 11   | {Dates}     | **APIs & Data Integration**              | Time Complexity: Sorting                            | HW #9     |
| 12   | {Dates}     | **Data Processing**                      | APIs                                                | HW #10    |
| 13   | {Dates}     | **Review & Exam #2**                     | *No Lab*                                            | *No HW*   |
| 14   | {Dates}     | **AI**                                   | Data Pipelines                                      | *No HW*   |
| 15   | {Dates}     | **Project Q&A Day**                      | *No Lab*                                            | *No HW*   |

### Attendance
Regular **in-person** attendance in both lectures and labs is expected, but is not required and will not be counted toward your final grade. No virtual option will be provided. Students are​ ​expected to attend all class and laboratory periods​.​ Those who fail to attend class and laboratory regularly are inviting scholastic difficulty. ​If you plan to miss an assignment or need an extension due to the observance of a religious holiday or a similar extenuating circumstance, please let us know at least two weeks in advance. You will still be responsible for any work you will miss on that day if applicable. For further information check here: [http://catalog.utexas.edu/general-information/academic-policies-and-procedures/attendance/](http://catalog.utexas.edu/general-information/academic-policies-and-procedures/attendance/).

### Course Assignments
Homework and laboratory assignments will generally be assigned each week. Homework assignments will be assigned on {HW Assign Day} at {HW Assign Time} immediately following lecture and will be due the following {HW Due Day} at {HW Due Time}. Laboratory assignments will be provided an hour before your scheduled section and be due by {Lab Due Time} the night before your section. A ​digital copy​ must be submitted via Canvas to facilitate grading. Late assignments will receive a {Late Penalty}% penalty per day, up to {Max Late Days} days late.
...
### Course Project
No final exam will be scheduled for this course. Instead, you will complete an individual final project. The final project is an opportunity for you to apply the programming skills and problem-solving techniques learned throughout the course to real problems. You will have two options for completing the project:
...
Projects are due _at midnight_ on the date of our course's final exam date. You can find the final exam schedule here: {Final Exam Schedule URL}.
